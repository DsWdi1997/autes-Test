...
public class ExcelUtil {
    ...
    private static <T> void setValue(Object obj, List<Object> data,
                                     List<Object> heads, Map<String, Method> methods) throws IllegalArgumentException, IllegalAccessException,
    ...
    private static <T> Map<String, Method> getSetMethod(Class<T> clz, List<Object> heads) {
